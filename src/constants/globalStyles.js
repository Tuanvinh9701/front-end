...
export default {
  ...
  // text
  // ///////////////////////////////////////////////////////////////////////////
  textGroup710: { fontFamily: fonts.learningenglishRegular, fontSize: 10 },
  textGroup712: { fontFamily: fonts.learningenglishRegular, fontSize: 12 },
  textGroup714: { fontFamily: fonts.learningenglishRegular, fontSize: 14 },
  textGroup716: { fontFamily: fonts.learningenglishRegular, fontSize: 16 },
  textGroup718: { fontFamily: fonts.learningenglishRegular, fontSize: 18 },
  textGroup7Bold12: { fontFamily: fonts.learningenglishBold, fontSize: 12 },
  textGroup7Bold16: { fontFamily: fonts.learningenglishBold, fontSize: 16 },
  textGroup7Bold18: { fontFamily: fonts.learningenglishBold, fontSize: 18 },
  textGroup7Bold20: { fontFamily: fonts.learningenglishBold, fontSize: 20 },
  textGroup7Bold22: { fontFamily: fonts.learningenglishBold, fontSize: 22 },
  textGroup7Bold24: { fontFamily: fonts.learningenglishBold, fontSize: 24 },
